export default function MosqueSilhouette({ className = "" }) {
  return (
    ...
    >
      ...
      />
      {/* Left minaret */}
      <rect x="650" y="100" width="8" height="220" fill="#D4AF37" opacity="0.15" />
      <circle cx="654" cy="95" r="6" fill="#D4AF37" opacity="0.2" />
      {/* Right minaret */}
      <rect x="782" y="100" width="8" height="220" fill="#D4AF37" opacity="0.15" />
      <circle cx="786" cy="95" r="6" fill="#D4AF37" opacity="0.2" />
      {/* Side domes */}
      <path
      ...
      />
      {/* Ground line */}
      <rect x="0" y="300" width="1440" height="20" fill="#D4AF37" opacity="0.06" />
    </svg>
  );
}
